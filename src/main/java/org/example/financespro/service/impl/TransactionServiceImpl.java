...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Mono<TransactionResponseDto> processTransaction(TransactionRequestDto requestDTO) {
        return Mono.just(requestDTO)
                ...
                .filter(req -> req.getTransactionAmount() != null && req.getTransactionAmount().compareTo(BigDecimal.ZERO) > 0)
                ...
                .flatMap(req -> accountRepository.findById(req.getAccountId())
                        ...
                        .flatMap(account -> {
                            ...
                            if (newBalance.compareTo(BigDecimal.ZERO) < 0) {
                                return Mono.error(new CustomException("Insufficient funds for transaction"));
                            }
                            ...
                            return accountRepository.save(updatedAccount)
                                    ...
                                    .map(savedTransaction -> TransactionMapper.toResponseDTO(savedTransaction, newBalance));
                        }));
    }
}
